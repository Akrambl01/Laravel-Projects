                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('articles.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="author" id="author" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>

                        <button type="submit" style="background: rgb(0, 0, 0); color: white"  class="bg-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Créer l'article</button>
                    </form>
                </div>
            </div>
        </div>
